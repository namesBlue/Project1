...
public class PlayerController0 : MonoBehaviour
{
    ...
    void Jump()
    {
        ...
        //Debug.DrawRay(pos, Vector2.down, Color.red, 1.0f);
        RaycastHit2D onGround = Physics2D.Raycast(pos, Vector2.down, 0.2f, (1<<8)|(1<<9));
        if ((Input.GetAxisRaw("Vertical") == 1f) && onGround)
        {
